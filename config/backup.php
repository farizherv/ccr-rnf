...
$backupArchivePassword = trim((string) env('BACKUP_ARCHIVE_PASSWORD', ''));
...
return [
    ...
    'backup' => [
         ...
         */
        'password' => $backupArchivePassword !== '' ? $backupArchivePassword : null,
         ...
         */
        'encryption' => $backupArchivePassword !== '' ? 'default' : false,
