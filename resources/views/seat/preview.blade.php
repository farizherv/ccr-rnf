...
<style>
    ...
    .value-col {
        ...
        /* ===== COMPONENT INFORMATION ALIGN FIX ===== */
    .ci-label {
        width: 180px;          /* ini yang bikin sejajar */
        padding-left: 8px;
        font-weight: normal;
    }

    .ci-colon {
        width: 15px;           /* titik dua rapat */
        text-align: center;
    }

    .ci-value {
        width: auto;
        padding-left: 6px;     /* DEKAT dengan : */
    }
...
<div class="a4">
    ...
    <table class="info-outer">
        <tr>
            <td colspan="3" class="title-inside">COMPONENT CONDITION REPORT</td>
        </tr>

        <tr>
            <td colspan="3" class="info-header">COMPONENT INFORMATION:</td>
        </tr>

        <tr>
            <td class="ci-label">COMPONENT</td>
            <td class="ci-colon">:</td>
            <td class="ci-value">{{ $report->component }}</td>
        </tr>
        <tr>
            <td class="ci-label">MAKE</td>
            <td class="ci-colon">:</td>
            <td class="ci-value">{{ $report->make }}</td>
        </tr>
        <tr>
            <td class="ci-label">MODEL</td>
            <td class="ci-colon">:</td>
            <td class="ci-value">{{ $report->model }}</td>
        </tr>
        <tr>
            <td class="ci-label">UNIT</td>
            <td class="ci-colon">:</td>
            <td class="ci-value">{{ $report->unit }}</td>
        </tr>
        <tr>
            <td class="ci-label">WO / PR</td>
            <td class="ci-colon">:</td>
            <td class="ci-value">{{ $report->wo_pr }}</td>
        </tr>
        <tr>
            <td class="ci-label">CUSTOMER</td>
            <td class="ci-colon">:</td>
            <td class="ci-value">{{ $report->customer }}</td>
        </tr>
        <tr>
            <td class="ci-label">INSPECTION DATE</td>
            <td class="ci-colon">:</td>
            <td class="ci-value">
    ...
    {{-- MAIN TABLE HEADER --}}
    <table class="border-2" style="margin-top:-15px;">
        <tr>
            <td class="section-header" style="width:50%;">
                Part Number – Name – Modifier Code <br>
                (RH/LH/Upper/Lower etc)<br>
                <span class="sub-header">
                    – Notes Identify Type, Amount, Location of Wear,<br>
            ...
            <td class="section-header" style="width:50%;">
                OBSERVATION <br>
                <span class="sub-header">
                    To Help Explain Progression/Stage of Failure,<br>
