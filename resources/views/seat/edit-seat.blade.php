    ...
    <div class="box">
        ...
        <div class="info-grid-edit">
            ...
            <div>
                ...
                <input type="text" class="input" value="{{ $report->group_folder }}" readonly>
            ...
            <div>
                <label>Unit</label>
                <input type="text" name="unit" class="input" value="{{ $report->unit }}">
            </div>

            <div>
                <label>WO / PR</label>
                <input type="text" name="wo_pr" class="input" value="{{ $report->wo_pr }}">
            </div>
...
@foreach($report->items as $item)
    <form id="delItem{{ $item->id }}"
          action="{{ route('seat.item.delete', $item->id) }}"
          method="POST"
          style="display:none;">
        @csrf
        @method('DELETE')
...
<style>
    ...
    .header-logo-master { width: 95px; }
    .header-title-master { font-size: 28px; font-weight: 800; }
    .header-subtitle-master { font-size: 15px; color: #666; }
