...
<div class="seat-create-page">
    ...
    @if ($errors->any())
        <div class="error-box">
            <strong style="color:#b30000; font-size:15px;">⚠️ Gagal menyimpan perubahan CCR Seat:</strong>
    ...
    <form action="{{ route('seat.update.header', $report->id) }}"
          ...
          x-data="manageSeatEdit()"
          x-init="init()"
          @submit="onFormSubmit($event)"
          @remove-seat-item.window="removeItem($event.detail)"
          @remove-old-seat-item.window="removeOldItem($event.detail)">
        ...
        <div x-show="tab === 'ccr'" x-cloak>
            <input type="hidden" name="group_folder" value="{{ $report->group_folder }}">
                        ...
                        <div class="doc-a4">
                            ...
                            <table class="doc-info-table">
                                ...
                                <tr>
                                    ...
                                    <td class="doc-colon">:</td>
                                    <td class="doc-v">
                                        <input type="text" name="unit" class="doc-input" value="{{ old('unit', $report->unit) }}">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="doc-colon">:</td>
                                    <td class="doc-v">
                                        <input type="text" name="wo_pr" class="doc-input" value="{{ old('wo_pr', $report->wo_pr) }}">
                                    </td>
                                </tr>
                                <tr>
                            ...
                            @foreach($report->items as $item)
                                ...
                                <div class="doc-item-block"
                                     ...
                                     x-show="!removed"
                                     @restore-old-seat-item.window="restoreOldItem($event.detail)"
                    ...
                    <div class="ccr-side-content" x-show="sidebarOpen" x-transition.opacity>
                        <div class="ccr-side-card">
                            ...
                            <div class="ccr-folder-picker">
                                <label for="group_folder_seat_sidebar_edit">Group Folder</label>
                                <input type="text"
                                       id="group_folder_seat_sidebar_edit"
...
function itemEditor(itemKey, namePrefix, el, isExisting = false, oldItemId = null) {
    ...
    return {
        ...
        removeOldItemInline() {
            ...
            this.syncInputFiles();
            this.removed = true;
            this.$dispatch('remove-old-seat-item', { id: this.oldItemId });
        },
...
function manageSeatEdit() {
    ...
    return {
        ...
        deleteItemUrlTemplate: @js(route('seat.item.delete', ['item' => '__ITEM__'])),
        ...
        flushEditAutosave(force = false) {
            ...
            this.ccrSaveStatus = 'Auto-saved (DB) ' + (new Date()).toLocaleTimeString('id-ID');
            try {
                window.dispatchEvent(new CustomEvent('ccr:seat-force-save', {
                    detail: {
                        source: 'edit-submit',
                        force: !!force,
                        ts: Date.now(),
        ...
        getSubmitFileInputs() {
            if (!this.$el) return [];
            const allowedPrefixes = ['items[', 'new_items[', 'seat_item_photos['];
        ...
        async deleteOldItemDirect(id) {
            ...
            try {
                ...
                window.dispatchEvent(new CustomEvent('restore-old-seat-item', { detail: { id } }));
...
@include('seat.partials.create_seat_style')
