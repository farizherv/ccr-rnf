...
<div data-page="manage-engine">
    ...
    [data-page="manage-engine"] .btn-back:hover{ background:#2b2d2f; transform:translateY(-2px) }
    ...
    [data-page="manage-engine"] .header-left{ display:flex; align-items:center; gap:18px }
    [data-page="manage-engine"] .header-logo{ width:80px; height:80px; object-fit:contain }
    [data-page="manage-engine"] .header-title{ font-size:20px; font-weight:800; margin:0 }
    [data-page="manage-engine"] .header-subtitle{ font-size:14px; color:#555; margin-top:4px }
    ...
    [data-page="manage-engine"] .filter-large{ flex:1; margin-right:30px; }
    [data-page="manage-engine"] .filter-small{ flex:0 0 240px; }
    ...
    @media (max-width:1024px){
        [data-page="manage-engine"] .filter-row{flex-wrap:wrap;gap:18px}
        [data-page="manage-engine"] .filter-large{flex:1 0 100%;margin-right:0;padding-right:30px;box-sizing:border-box}
        [data-page="manage-engine"] .filter-small{flex:1}
    }
    @media (max-width:600px){
        [data-page="manage-engine"] .filter-row{flex-direction:column;align-items:flex-start;gap:16px}
        [data-page="manage-engine"] .filter-large{width:100%;padding-right:30px;box-sizing:border-box}
        [data-page="manage-engine"] .filter-small{width:100%}
    }
    ...
    [data-page="manage-engine"] .report-main{ display:flex; flex-direction:column; gap:6px }
    [data-page="manage-engine"] .report-title{ font-size:16px; font-weight:700 }
    ...
    [data-page="manage-engine"] .time-pill{ background:#eee; padding:6px 14px; border-radius:999px }
    [data-page="manage-engine"] .time-text,
    [data-page="manage-engine"] .time-wita{ font-weight:700; color:#E40505 }
    [data-page="manage-engine"] .time-wita{ margin-left:-6px }
    [data-page="manage-engine"] .note-pill{
    ...
    [data-page="manage-engine"] .report-actions form{ margin:0; }
    ...
    [data-page="manage-engine"] .btn-premium:hover{ transform:translateY(-2px); box-shadow:0 4px 10px rgba(0,0,0,.15) }
    [data-page="manage-engine"] .edit-btn{ background:#6b7075 }
    [data-page="manage-engine"] .word-btn{ background:#185ABD }
    [data-page="manage-engine"] .lihat-btn{ background:#F57C00 }
    [data-page="manage-engine"] .lihat-btn:hover{ background:#d96b00 }
    [data-page="manage-engine"] .icon-btn{ width:18px; height:18px }
    ...
    [data-page="manage-engine"] .status-dot{
      width:10px;
      height:10px;
      border-radius:999px;
      display:inline-block;
    ...
    [data-page="manage-engine"] .dot-draft{ background:#9ca3af; }
    [data-page="manage-engine"] .dot-waiting{ background:#f59e0b; }
    [data-page="manage-engine"] .dot-approved{ background:#22c55e; }
    [data-page="manage-engine"] .dot-rejected{ background:#ef4444; }

    /* ========================= SUBMIT BUTTON ========================= */
    [data-page="manage-engine"] .btn-premium.btn-submit{
        background:#9F8170 !important;
    }
    [data-page="manage-engine"] .btn-premium.btn-submit:hover{
    ...
    [data-page="manage-engine"] .bulk-btn:hover{
    ...
    [data-page="manage-engine"] .bulk-btn:active{
    ...
    [data-page="manage-engine"] .report-actions a.btn-premium,
    ...
    [data-page="manage-engine"] .report-actions a,
    [data-page="manage-engine"] .report-actions form,
    [data-page="manage-engine"] .report-actions button{
        width:100%;
        justify-content:center;
    }
    ...
    [data-page="manage-engine"] .status-note-btn:hover{ transform:translateY(-1px); }
    [data-page="manage-engine"] .status-note-btn .note-ico{ font-size:16px; line-height:1; }
    [data-page="manage-engine"] .status-note-btn .note-txt{ font-size:14px; }
    ...
    [data-page="manage-engine"] .note-modal.is-open{ display:block; }
    ...
    /* ===================== FIX WARNA ACTION ===================== */
    [data-page="manage-engine"] .btn-premium.btn-inreview,
    ...
    [data-page="manage-engine"] .btn-premium.btn-resubmit,
    ...
    [data-page="manage-engine"] .btn-premium.btn-resubmit:hover,
