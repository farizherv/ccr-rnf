...
<div x-data="{ selectedReports: [] }">
    ...
    <form x-show="selectedReports.length > 0"
          action="{{ route('ccr.engine.deleteMultiple') }}"
          method="POST"
        ...
        <button type="submit"
                ...
                onclick="return confirm('Yakin ingin menghapus laporan ENGINE yang dipilih?')">
...
<div class="report-card"
    ...
    <div class="report-left">
        ...
        <div class="report-main">
            ...
            <div class="report-meta">
                ...
                <span>Tanggal: <b>{{ date('Y-m-d', strtotime($r->inspection_date)) }}</b></span>
    ...
    <div class="report-actions">
        <a href="{{ route('engine.preview', $r->id) }}" class="btn-premium lihat-btn">
            👁️ Lihat
        </a>
        <a href="{{ route('engine.edit', $r->id) }}" class="btn-premium edit-btn">
            ✏️ Edit</a>
...
/* ======================================================
🔥 BULK DELETE BUTTON — INI YANG KAMU BUTUH 🔥
====================================================== */
.btn-premium.pdf-btn,
...
.btn-premium.pdf-btn:hover{
    background:#a81f1f !important;
}

/* ANTI GREY / ANTI DISABLED */
